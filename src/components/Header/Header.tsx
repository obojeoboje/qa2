    ...
    <header className={styles.header}>
      ...
      <div className={styles.info}>
        <div className={styles.leftInfo}>
          Овладей ключевыми навыками и инструментами под руководством опытного
          наставника для успешного трудоустройства в IT на позицию тестировщика.
        </div>
        <div className={styles.rightInfo}>
          Полный возврат денег, если устроиться на работу не получится, устроишься на зарплату ниже 100 000 ₽ или обучение не понравится.
        </div>
      </div>
